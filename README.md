...
---
### 👨‍💻 About Me:
I am a Full Stack Data Analyst <img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30">

- :telescope: I'm a Data Analyst proficient in unraveling insights from diverse datasets, enriching both frontend and backend strategies for informed decision-making and innovation in web applications.

- :seedling: Exploring ThreeJs, Tensorflow, Ai and Blender.

- :zap: In my free time, I solve problems on CodeWars, read books (latest read - Sword of Kaigen) or watch movies (latest watch - Dune 2).
...
<div>
  ...
  <img src="https://github.com/devicons/devicon/blob/master/icons/pandas/pandas-original.svg" title="Pandas" alt="Pandas UI" width="40" height="40"/>&nbsp;
